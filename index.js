...
document.querySelector("#submit").addEventListener("click", () => {
  ...
  ${
    storage
      ? `<div class="mt-5">  <h1 class="text-center">Previous Submissions <button class="text-blue-800 text-xs" onclick={localStorage.clear();location.reload()}>Clear History</button></h1>
